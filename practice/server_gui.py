...
def gui_create_model(database):
    ...
    list_table.setHorizontalHeaderLabels(['Имя Клиента', 'IP Адресс', 'Порт', 'Время подключения'])
...
# GUI - Функция которая реализует заполнение таблицы историей сообщений
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.active_clients_table.move(10, 35)
