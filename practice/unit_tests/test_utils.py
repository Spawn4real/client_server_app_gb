...
from common.utils import get_messages, send_messages
...
class TestUtils(unittest.TestCase):
    ...
    def test_send_message_true(self):
        ...
        send_messages(test_socket, self.test_dict_send)
    ...
    def test_send_message_with_error(self):
        ...
        self.assertRaises(TypeError, send_messages, test_socket, "wrong_dictionary")
    ...
    def test_get_message_ok(self):
        ...
        self.assertEqual(get_messages(test_sock_ok), self.test_dict_recv_ok)

    def test_get_message_error(self):
        """Тест функции приёма сообщения"""
        test_sock_err = TestSocket(self.test_dict_recv_err)
        # тест корректной расшифровки ошибочного словаря
        self.assertEqual(get_messages(test_sock_err), self.test_dict_recv_err)
